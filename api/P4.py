...
def MP4_video(input_file_path, output_file_path, docker = None):
        ...
        if docker:
            ...
            command = docker + ["ffmpeg", "-y",
            "-i", input_file_path,  
            "-t", "60",  #Duration of 20 seconds
            "-c:v", "libx264",
            "-c:a", "aac", #AAC Codec 
            "-f", "hls",
...
def MKV_video(input_file_path, output_file_path, docker = None):
        ...
        if docker:
            ...
            # aquest comando funciona: convert to black and white
            # command = docker + ['ffmpeg', '-i', input_file_path, '-vf', 'format=gray', output_file_path]
